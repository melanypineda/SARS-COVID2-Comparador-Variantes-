...
# Análisis de Datos
Al finalizar los 10 pases, se realiza la extracción de ARN y secuenciación para comparar los resultados con la secuencia de referencia (NC_045512.2). El código para esta comparación se encuentra en la carpeta codigo.
